        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white shadow-lg border border-gray-100">
              <CardHeader>
                <div className="w-12 h-12 flex items-center justify-center text-[#003880] mb-2">
                  <Briefcase className="w-12 h-12" />
                </div>
                <CardTitle className="text-2xl font-semibold">Protect Your Income</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white shadow-lg border border-gray-100">
              <CardHeader>
                ...
                <CardTitle className="text-2xl font-semibold">Support When Life Takes an Unexpected Turn</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white shadow-lg border border-gray-100">
              <CardHeader>
                ...
                <CardTitle className="text-2xl font-semibold">Plan Today to Protect Tomorrow</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
